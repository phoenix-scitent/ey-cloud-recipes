clone_scripts(
  ...
  'database' => {
    ...
    :backup_hour => "4",                                             # The hour at which the latest db dump should be uploaded to S3 (UTC)
    :restore_hour => "4"                                             # The hour at which the latest db dump should be downloaded from S3 and imported (UTC)
  },
  'deploy' => {
    :hour => "4",                                                    # The hour at which the automated deploy should happen (UTC)
