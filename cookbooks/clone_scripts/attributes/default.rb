clone_scripts(
  ...
  #  :backup_hour => "1",                                           # The hour at which the latest db dump should be uploaded to S3 (UTC)
    :restore_hour => "2"                                           # The hour at which the latest db dump should be downloaded from S3 and imported (UTC)
  },
  'deploy' => {
    :hour => "2",                                                   # The hour at which the automated deploy should happen (UTC)
