clone_scripts(
  ...
  'database' => {
    ...
    :backup_hour => "20",
    :backup_minute => "40",                                            # The hour at which the latest db dump should be uploaded to S3 (UTC)
    :restore_hour => "21"                                           # The hour at which the latest db dump should be downloaded from S3 and imported (UTC)
  },
  'deploy' => {
    :hour => "20",
    :minute => "40",                                                   # The hour at which the automated deploy should happen (UTC)
    :branch => "master-data-test"                                   # The branch to deploy for the automated deploy
  },
  'rsync' => {
    :hour => "20",
    :minute => "40",                                                   # The hour at which to begin the rsync (UTC)
